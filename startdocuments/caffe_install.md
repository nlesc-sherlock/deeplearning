...
EasyBuild
=========
- Following http://easybuild.readthedocs.org/en/latest/Installation.html (with a
  few additions):
...
protobuf
--------
N.B.: PROBABLY SHOULDN'T INSTALL NEWEST VERSION! INCOMPATIBLE WITH PYCAFFE.
CONFIRMED: THIS IS OBSOLETE, INSTALL WITH EASYBUILD (SEE ABOVE).
